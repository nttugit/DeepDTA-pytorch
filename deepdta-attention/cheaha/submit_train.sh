...
SBATCH="$REPO/deepdta-attention/cheaha/train.sbatch"
...
OUT="$RUNS_ROOT/deepdta-attention/${DATASET}/${RUN_NAME}"
mkdir -p "$OUT"
...
printf "%s\t%s\tdeepdta-attention\t%s\t%s\t%s\t%s\t%s\t%s\n" \
